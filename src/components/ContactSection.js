...
const ContactSection = () => {
    return (
        <div className={`${common.small} ${common.aligned} ${styles.container}`}>
            ...
            <p>Other relevant info can be found in my resume <span className={styles.highlight}><a href="https://drive.google.com/file/d/1-l7lqzLC9QyCTNDhHE3jUuJoMgnDttsj/view" target="_blank">here</a></span>.</p>
